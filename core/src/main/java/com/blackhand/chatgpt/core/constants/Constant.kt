package com.blackhand.chatgpt.core.constants
...
class Constant {
    companion object {
        ...
        const val CREATE_USER_ERROR ="msg"
        ...
        const val IS_REQUIRED = "is required"
        const val PHONE_NUMBER_ERROR = "Phone Number Already Used"
    }
}